function XPolyline(points, color, weight, opacity, opts, gapPx, headLength, headColor, headWeight, headOpacity) {	
...
//XPolyline.prototype = new GOverlay();
XPolyline.prototype = new google.maps.OverlayView();
...
XPolyline.prototype.onRemove = function() {
...
XPolyline.prototype.copy = function(map) {
    return new XPolyline(this.points,this.color,this.weight,this.opacity,this.opts,this.gapPx, this.headLength, this.headColor, this.headWeight, this.headOpacity);
}


XPolyline.prototype.recalc = function() {
...
XPolyline.prototype.addHead = function(x,y,theta,zoom) {
