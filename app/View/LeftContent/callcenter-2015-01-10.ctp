		...
		<div id="div-1" class=" body">
			<div class="input-append">
				...
				<button id="btnSearch" class="btn" type="button"
					title="Search by User Name, Client Name, Contact Name, Vehicle Registration Number, Device ID, Tracker ID, Unit Sim, Contact Email, Contact Mobile  ">
	...
	init:function(){
		...
		$('#btnSearch').bind('click',function(){
			...
			if(f[0]=="Contact"){
				...
				searchType = f[0];
				url = 'clientDevices/getDeviceInfoByUserId/'+f[1];
			}
			VTS_LEFT.deviceids = [];				
			APP_HELPER.ajaxSubmitDataCallback(url,'',function(data){
				$('#trackers').empty();
