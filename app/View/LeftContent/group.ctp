<div class="media user-media hidden-phone"
	...
	<img src="<?php echo $this->webroot;?>files/logo/<?php echo $logo?>"
		width="96px" /><?php }else{?>
		<img src="<?php echo $this->webroot;?>files/logo/logo.png"
		width="130px" /><?php }?>
	<div class="clear"></div>
	<br /> 
	<a class="btn btn-inverse btn-mini" href="javascript:;"
		onclick="APP_HELPER.loadIframe('clientInfos/logo/<?php echo $user['client_info_id']?>','#ajax-content');">
		Change Logo</a>
</div>
<ul id="menu" class="unstyled accordion collapse in">
	<li class="menu-ajax"><a href="#/trackerTracks/trackers_summary"
		>
		<i class="icon-map-marker icon-large"></i> Tracking Summary</a>
	</li>
	<li class="menu-ajax"><a href="#/histories/index">
		<i class="icon-time icon-large"></i> History</a>
	</li>
	<li><a href="javascript:;"	id="lnkMonitor">
		<i class="icon-desktop icon-large"></i> Monitor</a>
	</li>
