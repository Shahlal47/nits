<div class="span12">
	<div class="box dark">
		<header>
			...
			<div class="toolbar">
				<ul class="nav">
					...
					<li><a href="javascript:;"
						onclick="APP_HELPER.ajaxDeleteRecordAction('vehicleTypes/delete/'+$('#VehicleTypeId').val());">
		...
		<div class="in body" id="div-1">
			...
			$data = $this->Js->get('#VehicleTypeEditForm')->serializeForm(array('isForm' => true, 'inline' => true));
			$this->Js->get('#VehicleTypeEditForm')->event(
					'submit',
		$this->Js->request(
		array('action' => 'edit/'.$this->request->data['VehicleType']['id']),
		array(
						'data' => $data,
						'async' => true,
						'dataExpression'=>true,
...
<script>
	$(function() {
		APP_COMMON.initPage('Edit Vehicle Type');
		$('#ajax-page-title').html('<i class="icon-user"></i> Vehicle Type : Edit');	   
	});
</script>
