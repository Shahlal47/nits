		...
		<div id="top">
			<div class="navbar navbar-static-top">
				<div class="navbar-inner">
					...
					<?php //echo $this->element("Roles/".$this->request['action']) ?>
					</div>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	function monitoring(){
		...
		APP_HELPER.ajaxSubmitDataCallback('dashboard/left/monitoring','',function(data){
			
			$('#left').html(data);
			APP_HELPER.ajaxSubmitDataCallback('monitoring/monitoring','',function(data){
	...
	function animation(){
		...
		APP_HELPER.ajaxSubmitDataCallback('animations/animation','',function(data){
