...
<script type="text/javascript"
	src="http://maps.googleapis.com/maps/api/js?v=3&sensor=false&libraries=geometry"></script>
<script type="text/javascript"
...
<body>
	...
	<div id="wrap">
		...
		<div id="top">
			...
			<div class="navbar navbar-static-top">
				<div class="navbar-inner">
					...
					<?php echo $this->element('Roles/Admin/topnav') ?>
					</div>
				</div>
			</div>
			<!-- /.navbar -->
		...
		<?php echo $this->element('Roles/Admin/leftnav') ?>
			<!-- END MAIN NAVIGATION -->
