<div class="span12">
	<div class="box">
		<header>
			...
			<h5>
				<?php echo __('Edit Client Expense'); ?>
			</h5>
			<div class="toolbar">
				<ul class="nav">
					...
					<li><a href="javascript:;"
						onclick="APP_HELPER.ajaxDeleteRecord('clientExpenses/delete/'+$('#ClientExpenseId').val());">
		...
		<div class="in body" id="div-1">
			...
			$data = $this->Js->get('#ClientExpenseEditForm')->serializeForm(array('isForm' => true, 'inline' => true));
			$this->Js->get('#ClientExpenseEditForm')->event(
					'submit',
				$this->Js->request(
 array('action' => 'edit/'.$this->request->data['ClientExpense']['id']),
				array(
						'data' => $data,
						'async' => true,
						'dataExpression'=>true,
