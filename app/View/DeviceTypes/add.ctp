<div class="span12">
	<div class="box dark">
		...
		<h5>
		<?php echo __('Add Device Type'); ?>		</h5>
		<div class="toolbar">
			<ul class="nav">
...
<?php 
				...
				$data = $this->Js->get('#DeviceTypeAddForm')->serializeForm(array('isForm' => true, 'inline' => true));
				$this->Js->get('#DeviceTypeAddForm')->event(
					'submit',
				$this->Js->request( 		
 array('action' => 'add'),		
				array(
...
<script>
	$(function() {
		APP_COMMON.initPage('Add Device Type');
		$('#ajax-page-title').html('<i class="icon-user"></i> Device Type : Add');	   
	});
</script>