		...
		<div class="span12">
			<div class="box">
				...
				<form id="frmGeofences" class="form-inline"
					...
					<input id="geofence_points"	name="geofence_points" type="hidden"> 
					<input id="geo_shape" name="geo_shape" type="hidden"> 
					<input id="name" name="name" type="text" class="input" placeholder="Fence Name" data-placement="bottom" data-original-title="Fence Name" rel="tooltip">
					
					<?php echo $this->Form->input('geofence_type_id', array('label'=>false,'div'=>false, 'placeholder'=>"Fence Type", 'data-placement'=>"bottom", 'data-original-title'=>"Fence Type",  'rel'=>"tooltip",  'class'=>'input-medium','options'=>$geofenceTypes,'empty'=>''));?>
					...
					<div class="btn-group">
						<a id="btnSave" data-placement="bottom" data-original-title="Save" href="#"
							rel="tooltip" class="btn btn-primary "> <i class="icon-save"></i>
						</a>
					</div>
					<div class="btn-group">
						<a id="btnClear" data-placement="bottom"
							data-original-title="Clear" href="#" rel="tooltip"
							class="btn"> Clear </a>
					</div>
					<div class="btn-group">
						<a id="btnClearAll" data-placement="bottom"
							data-original-title="Clear All" href="#" rel="tooltip"
							class="btn"> Clear All </a>
					</div>
					<div class="btn-group">
						<a id="btnDelete" data-placement="bottom"
							data-original-title="Delete" href="#" rel="tooltip"
							class="btn btn-danger"> <i class="icon-remove"></i> </a>
					</div>
				</form>
				...
				<div id="div-geofence-list"
					...
					<select id="fence_list" multiple="multiple"
						style="height: 100%; width: 100%; float: left;" size="16">
					</select>
				</div>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#fence_list").on('dblclick', function(e) {
			var id = $(this).val();
		...
		$("#btnDelete").on('click', function(e) {
			...
			if(id==''){
				alert('No geo-fence tobe deleted!!!'); return;
			}
