<div class="span12">
	<div class="box dark">
		...
		<h5>
		<?php echo __('Add Tracker Type'); ?>		</h5>
		<div class="toolbar">
			<ul class="nav">
...
<?php 
				...
				$data = $this->Js->get('#TrackerTypeAddForm')->serializeForm(array('isForm' => true, 'inline' => true));
				$this->Js->get('#TrackerTypeAddForm')->event(
					'submit',
				$this->Js->request( 		
 array('action' => 'add'),		
				array(
...
<script>
	$(function() {
		...
		$('#ajax-page-title').html('<i class="icon-user"></i> Tracker Type : Add');	   
	});
</script>