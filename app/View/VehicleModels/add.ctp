<div class="span12">
	<div class="box">
		...
		<div class="in body" id="div-1">
			...
			$data = $this->Js->get('#VehicleModelAddForm')->serializeForm(array('isForm' => true, 'inline' => true));
			$this->Js->get('#VehicleModelAddForm')->event(
					'submit',
					$this->Js->request(
							array('action' => 'add'),
							array(
...
<script>
	$(function() {
		...
		$('#ajax-page-title').html('<i class="icon-user"></i> Vehicle Model : Add');	   
	});
</script>
