	...
	<div class="row-fluid">
		...
		<div class="span12">
			<div class="box">
				...
				<header>
					<h5>
						<i class="icon-edit"></i> Vehicle Status Report
					</h5>
					<div class="toolbar">
					...
					<table class="table table-bordered responsive">
						<thead>
							<tr>
								...
								<th width="10%">Current Update (Date/Time)</th>
								<th width="10%">Last Update (Date/Time)</th>
								<th width="10%">Motion</th>
								<th width="20%">Location</th>
								<th width="10%">Speed</th>
								<th width="10%">Engine Status</th>
							</tr>
						</thead>
						<tbody id="reportBody">
							<tr>
