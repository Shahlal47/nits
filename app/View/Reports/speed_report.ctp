<div
	...
	<div class="box">
		...
		<div class="collapse in body" id="reportFilter">
			...
			<?php echo $this->Form->create('SpeedReport', array('inputDefaults' => array('label' => false,'div' => false, 'error' => false), 'class'=>'form-horizontal'));
			?>
			<div style="margin: 0%;">
				<header>
					<div class="icons">
				...
				<?php echo $this->Form->hidden('SpeedReport.trackers', array('id'=>'trackers'));?>
				&nbsp;
			</div>
					...
					<tbody>
						...
						<tr>
							<td><span class="add-on"><i class="icon-calendar"> </i> </span> <input
								...
								name="data[SpeedReport][fromdate]">
							</td>
						</tr>
						...
						<tr>
							<td><span class="add-on"><i class="icon-calendar"> </i> </span> <input
								...
								name="data[SpeedReport][todate]"></td>
						</tr>
					</tbody>
				</table>
			</div>
			...
			<div style="margin: 0%;">
				...
				<table id="" style="width: 100%;" class="report_class">
					<tbody>
						<tr>
							<td><input type="radio" name="data[SpeedReport][status]"
						...
						<tr>
							<td><input type="radio" name="data[SpeedReport][status]"
								value="50"></input></td>
							<td>Max Speed Higher Than 50 Km/hr</td>
						</tr>
						<tr>
							<td><input type="radio" name="data[SpeedReport][status]"
								value="60"></input>
							</td>
							<td>Max Speed Higher Than 60 Km/hr</td>
						</tr>
						<tr>
							<td><input type="radio" name="data[SpeedReport][status]"
								value="70"></input>
							</td>
							<td>Max Speed Higher Than 70 Km/hr</td>
						</tr>
						<tr>
							<td><input type="radio" name="data[SpeedReport][status]"
								value="80"></input>
							</td>
							<td>Max Speed Higher Than 80 Km/hr</td>
						</tr>
					</tbody>
				</table>
			</div>
	...
	var ALERT_REPORT = {
			init : function(){
				...
				$('#btnShowReport').bind('click',function(){
					...
					var url = 'reports/ajaxSpeedReport';
					var data = $('#SpeedReportSpeedReportForm').serialize();
				...
				$('#btnShowGraph').bind('click',function(){
					...
					var url = 'reports/speedReportGraph';
					var data = $('#SpeedReportSpeedReportForm').serialize();
					APP_HELPER.ajaxSubmitDataCallback(url,data,function(d){
						$('#graphdiv').html(d);				
					});
