<div style="margin-left: -20px; margin-top: 10px; width: 220px; font-size: 0.9em;">
	<div class="box">
		<header>
			<div class="icons">
				<i class="icon-edit"></i>
					...
					<tbody>
						...
						<tr>
							<td><span class="add-on"><i class="icon-calendar"> </i> </span> <input
								...
								data-original-title="From Date-Time" name="data[frm][todate]">
							</td>
						</tr>
					</tbody>
				</table>
