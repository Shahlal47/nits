	...
	<div class="box">
		...
		<div class="collapse in body" id="reportFilter">
			...
			<div style="margin: 0%;">
				...
				<?php echo $this->Form->hidden('DistanceReport.trackers', array('id'=>'trackers'));?>
				&nbsp;
			</div>
					...
					<tbody>
						...
						<tr>
							<td><span class="add-on"><i class="icon-calendar"> </i> </span> <input
								...
								name="data[DistanceReport][fromdate]">
							</td>
						</tr>
						...
						<tr>
							<td><span class="add-on"><i class="icon-calendar"> </i> </span> <input
								...
								name="data[DistanceReport][todate]"></td>
						</tr>
					</tbody>
				</table>
			</div>
	...
	var ALERT_REPORT = {
			init : function(){
				...
				$('#btnShowReport').bind('click',function(){
					...
					var url = 'reports/ajaxDistanceReport';
					var data = $('#CreateDistanceReportForm').serialize();
				...
				$('#btnShowGraph').bind('click',function(){
					...
					var url = 'reports/distanceReportGraph';
					var data = $('#CreateDistanceReportForm').serialize();
					APP_HELPER.ajaxSubmitDataCallback(url,data,function(d){
						$('#graphdiv').html(d);	
					});
