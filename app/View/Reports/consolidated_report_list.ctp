	...
	<div class="row-fluid">
		...
		<div class="span12">
			<div class="box">
				...
				<header>
					<h5>
						<i class="icon-edit"></i> Consolidated Report
					</h5>
					<div class="toolbar">
					...
					<table class="table table-bordered responsive">
						<thead>
							<tr>
								...
								<th width="15%">Date</th>
								<th width="15%">Travel Time (Hrs)</th>
								<th width="15%">Stop Time (Hrs)</th>
								<th width="10%">Distance (km/s)</th>
								<th width="10%">Total Stops</th>
								<th width="10%">Avg. Stop Length</th>
								<th width="10%">Max Speed(km/hr)</th>
								<th width="10%">Avg. Speed(km/hr)</th>
							</tr>
						</thead>
						<tbody id="reportBody">
							<tr>
